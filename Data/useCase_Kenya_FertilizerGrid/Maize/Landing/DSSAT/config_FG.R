...
temp_file <- "RS_pdates_template.csv"  # Input file (.csv)
...
Soil_source <- "ISRIC"  # or "ISDA"
AOI <- T
Forecast <- F
fertilizer <- F  # All treatments have one fertilizer level defined in the DSSAT template
fert_factorial <- F  # Fertilizer recommendation and plant date from CSV file
fert_grid_RS <- T  # Fertilizer from NPK grid and plant dates from CSV file
