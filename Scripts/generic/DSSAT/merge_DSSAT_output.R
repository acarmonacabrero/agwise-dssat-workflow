...
merge_DSSAT_output <- function(
  ...
  for (varietyid in varietyids) {
    if (AOI) {
      ...
      path.to.extdata <- paste0(project_root, "/Data/useCase_", country, "_", useCaseName, "/", Crop, "/transform/DSSAT/AOI/", varietyid)
    } else {
      path.to.extdata <- paste0(project_root, "/Data/useCase_", country, "_", useCaseName, "/", Crop, "/transform/DSSAT/fieldData/", varietyid)
    }
  ...
  if (AOI) {
    dir_path <- paste0(project_root, "/Data/useCase_", country, "_", useCaseName, "/", Crop, "/result/DSSAT/AOI/")
  } else {
    dir_path <- paste0(project_root, "/Data/useCase_", country, "_", useCaseName, "/", Crop, "/result/DSSAT/fieldData/")
  }
  ...
  if (AOI) {
    saveRDS(all_results, file = paste0(dir_path, Soil_source, "_useCase_", country, "_", useCaseName, "_", Crop, "_AOI_season_", season, ".RDS"))
  }else{
